...
export interface NetworkSummaryRecord {
  ...
  windowStart: string;
  /**
   * The last instant covered. This — not `generatedAt` — is the moment the figures describe, and
   * it is always at least `bucketSeconds + latenessGraceSeconds` in the past by construction.
   */
  windowEnd: string;
