...
Last updated: 2026-09-04 (preview green end to end: real national data, sharded reads, 45/45 visual)
...
- [x] P10 — `Deploy Preview` run 23 green end to end: gates, deploy, data verification and the
...
| Smoke test                    | `Deploy Preview` run 23                    | 11 of 11 against the deployed pair                                                                                                                                                                                                                       | 2026-09-04 |
| Real data through the edge    | `Deploy Preview` run 23                    | Passed: viewport stops, nearby, stop board, search, route detail, journey plan, and that a viewport's stops carry the services calling at them                                                                                                           | 2026-09-04 |
| Deployed visual pass          | `Deploy Preview` run 23                    | 45 of 45 in Chromium at 1440/768/390: basemap paints (497,184 / 386,833 / 127,531 bytes), 8–12 tiles at 200, attribution present, 230 markers, arrival board opens on a real Leeds stop, no page scrolls sideways; 21 screenshots kept as a run artifact | 2026-09-04 |
